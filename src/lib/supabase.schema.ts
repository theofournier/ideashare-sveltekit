  ...
  public: {
    Tables: {
      ...
      profiles_approvals: {
        ...
        Relationships: [
          {
            foreignKeyName: "profiles_approvals_approver_id_fkey"
            columns: ["approver_id"]
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "profiles_approvals_follow_id_fkey"
            columns: ["follow_id"]
            referencedRelation: "profiles_follows"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "profiles_approvals_user_id_fkey"
            columns: ["user_id"]
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          }
